...
[ -e "src/main/resources/config/liquibase/changelog" ]                    && [ -e "node_modules/generator-jhipster/utils/origin-files/changelog.origin" ]                      && rm  -R  "src/main/resources/config/liquibase/changelog"                && cp -R "node_modules/generator-jhipster/utils/origin-files/changelog.origin"                       "src/main/resources/config/liquibase/changelog" && echo "Criando Novo src/main/resources/config/liquibase/changelog"
[ -e "src/main/resources/config/liquibase/master.xml" ]                   && [ -e "node_modules/generator-jhipster/utils/origin-files/master.xml.origin" ]                     && rm "src/main/resources/config/liquibase/master.xml"                    && cp    "node_modules/generator-jhipster/utils/origin-files/master.xml.origin"                      "src/main/resources/config/liquibase/master.xml" && echo "Criando Novo src/main/resources/config/liquibase/master.xml"
[ -e "src/main/webapp/app/entities/index.tsx" ]                           && [ -e "node_modules/generator-jhipster/utils/origin-files/index.tsx.origin" ]                      && rm "src/main/webapp/app/entities/index.tsx"                            && cp    "node_modules/generator-jhipster/utils/origin-files/index.tsx.origin"                       "src/main/webapp/app/entities/index.tsx" && echo "Criando Novo src/main/webapp/app/entities/index.tsx"
[ -e "src/main/webapp/app/shared/reducers/index.ts" ]                     && [ -e "node_modules/generator-jhipster/utils/origin-files/index.ts.origin" ]                       && rm "src/main/webapp/app/shared/reducers/index.ts"                      && cp    "node_modules/generator-jhipster/utils/origin-files/index.ts.origin"                        "src/main/webapp/app/shared/reducers/index.ts" && echo "Criando Novo src/main/webapp/app/shared/reducers/index.ts"
[ -e "src/main/webapp/app/shared/layout/menus/entities.tsx" ]             && [ -e "node_modules/generator-jhipster/utils/origin-files/entities.tsx.origin" ]                   && rm "src/main/webapp/app/shared/layout/menus/entities.tsx"              && cp    "node_modules/generator-jhipster/utils/origin-files/entities.tsx.origin"                    "src/main/webapp/app/shared/layout/menus/entities.tsx" && echo "Criando Novo src/main/webapp/app/shared/layout/menus/entities.tsx"
[ -e "src/main/java/com/mycompany/myapp/config/CacheConfiguration.java" ] && [ -e "node_modules/generator-jhipster/utils/origin-files/CacheConfiguration.java.origin" ]        && rm "src/main/java/com/mycompany/myapp/config/CacheConfiguration.java"  && cp    "node_modules/generator-jhipster/utils/origin-files/CacheConfiguration.java.origin"         "src/main/java/com/mycompany/myapp/config/CacheConfiguration.java" && echo "Criando Novo src/main/java/com/mycompany/myapp/config/CacheConfiguration.java"
...
# echo "$CInt - "
    ...
    [ -e "server/src/repository/$int.repository.ts" ] && rm "server/src/repository/$int.repository.ts" && echo "Apagando server/src/repository/$int.repository.ts"
