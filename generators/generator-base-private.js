 ...
 module.exports = class extends Generator {
     ...
     generateEntityClientImports(relationships, dto, clientFramework = this.clientFramework) {
         ...
         relationships.forEach(relationship => {
             ...
             if (true || (relationshipType === 'one-to-many' || relationshipType === 'many-to-many' || otherEntityIsEmbedded) || 
                 (relationshipType === 'many-to-one' || (relationshipType === 'one-to-one' && ownerSide === true) )) {
                 toBeImported = true;
             } else if (dto === 'no') {
                 toBeImported = true;
             } else {
